...
https://github.com/ankosoftware/ng2-bootstrap-modal#readme
####It works with Rxjs 6 angular 8.
...
##Installation
```npm
npm install ngm-bootstrap-modal --save
```
See [Live Demo](https://ngm-bootstrap-modal-demo.stackblitz.io)

See [Edit live Demo](https://stackblitz.com/edit/ngm-bootstrap-modal-demo)
...
### Step 1. import '**NgmBootstrapModalModule**' module
...
imports: [
    ...
    NgmBootstrapModalModule.forRoot({container:document.body})
  ]
```
